...
- [`TestGetBoundingBoxMessages`](skills/pdf/scripts/check_bounding_boxes_test.py#L8) (class)
- [`RectAndField`](skills/pdf/scripts/check_bounding_boxes.py#L11) (class)
- [`XMLEditor`](skills/docx/scripts/utilities.py#L41) (class)
- [`DocxXMLEditor`](skills/docx/scripts/document.py#L47) (class)
- [`Document`](skills/docx/scripts/document.py#L612) (class)
- [`ShapeWithPosition`](skills/pptx/scripts/inventory.py#L129) (class)
- [`ParagraphData`](skills/pptx/scripts/inventory.py#L137) (class)
- [`ShapeData`](skills/pptx/scripts/inventory.py#L266) (class)
- [`RedliningValidator`](skills/docx/ooxml/scripts/validation/redlining.py#L11) (class)
- [`PPTXSchemaValidator`](skills/docx/ooxml/scripts/validation/pptx.py#L10) (class)
- [`DOCXSchemaValidator`](skills/docx/ooxml/scripts/validation/docx.py#L14) (class)
- [`BaseSchemaValidator`](skills/docx/ooxml/scripts/validation/base.py#L11) (class)
- [`RedliningValidator`](skills/pptx/ooxml/scripts/validation/redlining.py#L11) (class)
- [`PPTXSchemaValidator`](skills/pptx/ooxml/scripts/validation/pptx.py#L10) (class)
- [`DOCXSchemaValidator`](skills/pptx/ooxml/scripts/validation/docx.py#L14) (class)
